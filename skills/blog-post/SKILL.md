...
**Every blog post MUST be staged to the virtual cache root directory using the exact layout prefix `blogs/` to register cleanly with the Virtual Filesystem Backend:**
